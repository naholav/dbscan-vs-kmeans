...
kmeans = perform_kmeans(scaled_features, n_clusters=optimal_clusters)
features.loc[:, 'Cluster'] = kmeans.labels_  # Add cluster labels for visualization

# 7. Evaluate Clustering Performance
silhouette_avg, davies_bouldin = evaluate_clustering(scaled_features, kmeans.labels_)
...
# 10. Save Results
save_path = '/Users/ardamulayim/Downloads/clustered_data.csv'
